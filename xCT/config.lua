...
-- xCT outgoing damage/healing options
	...
	["iconsize"] = 18,		-- icon size of spells in outgoing damage frame, also has effect on dmg font size if it's set to "auto"
...
-- appearence
	...
	["damagefont"] = "Fonts\\ZYKai_C.TTF",	 -- "Fonts\\ZYKai_T.TTF" is default WoW damage font
