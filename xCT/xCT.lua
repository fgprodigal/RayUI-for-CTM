...
for i=1,numf do
	...
	elseif(i==2)then
		...
		f:SetPoint("BOTTOMLEFT",UIParent, "BOTTOM", 120, 380)
		f:SetHeight(260)
		f:SetWidth(120)
	elseif(i==3)then
		f:SetJustifyH(ct.justify_3)
		f:ClearAllPoints()
		f:SetPoint("TOP",UIParent, "TOP", -2, -200)
		f:SetHeight(128)
		f:SetWidth(256)
	else
		f:SetJustifyH(ct.justify_4)
		f:SetPoint("BOTTOMLEFT",UIParent, "BOTTOM", 240, 380)
		f:SetHeight(260)
		f:SetWidth(140)
...
SlashCmdList["XCT"]=function(input)
	...
	elseif(input=="mypos")then
		...
		xCT1:SetWidth(180)
		xCT2:ClearAllPoints()
		xCT2:SetPoint("BOTTOMLEFT",UIParent, "BOTTOM", 120, 380)
		xCT2:SetHeight(260)
		xCT2:SetWidth(120)
		xCT3:ClearAllPoints()
		xCT3:SetPoint("TOP",UIParent, "TOP", -2, -200)
		xCT3:SetHeight(128)
		xCT3:SetWidth(256)
		xCT4:ClearAllPoints()
		xCT4:SetPoint("BOTTOMLEFT",UIParent, "BOTTOM", 240, 380)
		xCT4:SetHeight(260)
		xCT4:SetWidth(140)
	else
