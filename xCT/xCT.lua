...
for i=1,numf do
	...
	if(i==1)then
		...
		f:SetPoint("BOTTOMLEFT",UIParent, "BOTTOM", -310, 420)
		f:SetHeight(260)
		f:SetWidth(128)
	...
	elseif(i==2)then
		...
		f:SetPoint("BOTTOMLEFT",UIParent, "BOTTOM", -200, 420)
		f:SetHeight(260)
		f:SetWidth(128)
		local a,_,c=f:GetFont()
		if (ct.damagefontsize=="auto")then
	...
	elseif(i==3)then
		...
		f:SetPoint("BOTTOMRIGHT",UIParent, "BOTTOM", 310, 420)
		f:SetHeight(260)
		f:SetWidth(128)
		local a,_,c=f:GetFont()
		if (ct.damagefontsize=="auto")then
...
SlashCmdList["XCT"]=function(input)
	...
	elseif(input=="mypos")then
		...
		xCT3:SetWidth(256)
		xCT4:ClearAllPoints()
		xCT4:SetPoint("BOTTOMRIGHT",UIParent, "BOTTOM", 310, 420)
		xCT4:SetHeight(260)
		xCT4:SetWidth(128)
	else
