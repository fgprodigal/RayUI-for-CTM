...
function Bag:SlotUpdate(b)
	...
	if not b.frame.lock then
		b.frame.border:SetBackdropBorderColor(unpack(C.media.bordercolor))
	end
...
function Bag:InitBags()
	...
	f.goldText:SetFont(C.media.font, C.media.fontsize)
