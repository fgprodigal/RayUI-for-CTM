...
PostalSkin:SetScript("OnEvent", function(self, event)
	...
	Postal_OpenAllMenuButtonDownTex:SetTexture("Interface\\AddOns\\!RayUI\\Aurora\\arrow-down-active")
	...
	Postal_ModuleMenuButtonDownTex:SetTexture("Interface\\AddOns\\!RayUI\\Aurora\\arrow-down-active")
