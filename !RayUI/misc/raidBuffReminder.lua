...
if C["misc"].raidbuffreminder ~= true then return end
...
local function OnAuraChange(self, event, arg1, unit)
	...
	if (C["misc"].raidbuffreminderparty and GetNumPartyMembers() == 0 and GetNumRaidMembers() == 0) then 
		self:Hide()
		return
	else
		self:Show()
...
if C["misc"].raidbuffreminderparty then
