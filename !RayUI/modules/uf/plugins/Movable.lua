...
do
	...
	function frame:VARIABLES_LOADED()
		...
		_DB = R.SavePath["UFPos"] or {}
		R.SavePath["UFPos"] = _DB
...
do
	...
	getBackdrop = function(obj, isHeader)
		...
		backdrop.bd:SetPoint("TOPLEFT")
		backdrop.bd:SetPoint("BOTTOMRIGHT")
		backdrop.bd:SetFrameLevel(0)
		...
		backdrop:SetScript("OnEnter", function(self)
			self.name:SetTextColor(self.bd.glow:GetBackdropBorderColor())
			self.bd:StartGlow()
		end)
