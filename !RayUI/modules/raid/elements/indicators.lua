...
local Enable = function(self)
    if(self.freebIndicators) then
        ...
        self.AuraStatusTL:SetFont(indicator, C["raid"].indicatorsize, "THINOUTLINE")
        ...
        self.AuraStatusTR:SetFont(indicator, C["raid"].indicatorsize, "THINOUTLINE")
        ...
        self.AuraStatusBL:SetFont(indicator, C["raid"].indicatorsize, "THINOUTLINE")
        ...
        self.AuraStatusBR:SetFont(symbols, C["raid"].symbolsize, "THINOUTLINE")
        ...
        self.AuraStatusCen:SetFont(C["media"].font, C["media"].fontsize - 2, C["media"].fontflag)
        self.AuraStatusCen:SetShadowOffset(1.25, -1.25)
        self.AuraStatusCen:SetWidth(C["raid"].width)
